      ...
      <div className="devman_tm_testimonials">
        <div className="container">
          <div className="devman_tm_main_title" data-text-align="center">
            <span>أراء عملائنا</span>
            <h3>رأى عملائنا فى منتجاتنا</h3>
            {/* <p>
            ...
            >
              <SwiperSlide>
                <div className="list_inner">
                  ...
                  <div className="details">
                    ...
                    <div className="short">
                      <h3>شركه المنصوره المحدوده سينا كوال</h3>
              ...
              <SwiperSlide>
                <div className="list_inner">
                  ...
                  <div className="details">
                    ...
                    <div className="short">
                      <h3>شركه سوهاج للمشروبات,بارتى كوال</h3>
                      {/* <span>Designer</span> */}
                    </div>
                  </div>
                </div>
              ...
              <SwiperSlide>
                <div className="list_inner">
                  <img className="svg" src="img/svg/quote.svg" alt="" />
                  <p className="text">
                    أمانه فى التعامل وجديه فى العمل
                  </p>
                  <div className="details">
                    <div className="image">
                      <div
                    ...
                    <div className="short">
                      <h3>الشركه الفردوس مياه , الإستثمار السعوديه</h3>
