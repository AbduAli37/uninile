const aboutData = {
  designation: "شركه",
  title: "متخصصه فى خطوط الإنتاج",
  text: [
    "هي شركة مصرية رائدة في مجال التصنيع والتجارة - حيث بدأت الشركة نشاطها في السوق المصري عام 2006 من خلال إنشاء مشروعات صناعية للمستثمرين الصناعيين في مجالات الأغذية والمشروبات والتغليف والصناعات البلاستيكية مثل الحقن والنفخ والقذف.",
  ],
  skillIcons: [
